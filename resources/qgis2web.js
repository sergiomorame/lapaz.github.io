...
map.getView().fit([-11021718.978542, 2194017.884054, -11007513.029376, 2201135.878951], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Incidencias del Agua La Paz</h2>';
        return titleElement;
    })(),
